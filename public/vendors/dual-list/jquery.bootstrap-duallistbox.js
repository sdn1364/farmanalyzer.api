...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      moveSelectedLabel: 'انتقال انتخاب‌شده',
      moveAllLabel: '<i class="fal fa-angle-double-left"></i>',
      removeSelectedLabel: 'حذف انتخاب‌شده',
      removeAllLabel: '<i class="fal fa-angle-double-right"></i>',
      ...
      infoText: 'نمایش {0} نفر',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">Filtered</span> {0} from {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: 'لیست خالی',                                                        // when there are no options present in the list
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        '     <button type="button" class="btn moveall text-center" >' +
        '       <i></i>' +
        '       <i></i>' +
        '     </button>' +
        '     <button type="button" class="btn move text-center">' +
        '       <i></i>' +
        '     </button>' +
        '   </div>' +
        ...
        '       <i></i>' +
        '     </button>' +
        '     <button type="button" class="btn removeall text-center">' +
        '       <i></i>' +
        '       <i></i>' +
        '     </button>' +
        '   </div>' +
