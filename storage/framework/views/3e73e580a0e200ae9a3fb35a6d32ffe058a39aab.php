<?php $__env->startSection('breadcrumb'); ?>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('worker.index')); ?>">لیست کارگران</a></li>
            <li class="breadcrumb-item active" aria-current="page">کارگر جدید</li>
        </ol>
    </nav>
    <!-- end::breadcrumb -->
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('worker.store')); ?>" method="post" class="needs-validation" novalidate="">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Soheyl Delshad\Desktop\home work\farm analayzer\api\resources\views/pages/worker/create.blade.php ENDPATH**/ ?>