            ...
            @section('breadcrumb')
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('city.index')}}">لیست شهرها</a></li>
                ...
                <div class="col-md-9">
                    <div class="card">
                        ...
                        <div class="form-group">
                            <label for="">نام</label>
                            <input type="text" name="name" id="" class="form-control" placeholder="" aria-describedby="helpId" value="{{$city->name}}">
                        </div>
                        <div class="form-group">
