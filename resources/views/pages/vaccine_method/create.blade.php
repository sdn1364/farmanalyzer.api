...
@section('breadcrumb')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('vaccine_method.index')}}">لیست متد‌های واکسیناسیون</a></li>
...
@section('content')
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('vaccine_method.store')}}" method="post" class="needs-validation" novalidate="">
                        @csrf
