@extends('master')
@section('breadcrumb')
    <h3 class="page-title">تغییر کلمه عبور</h3>
    <!-- begin::breadcrumb -->
...
@section('content')
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('costume_reset_password',$user->id)}}" method="post" class="needs-validation" novalidate="">
                        @csrf
                        @method('put')
                        <div class="form-group">
                            ...
                            <div class="invalid-tooltip">
                                لطفا یک مقدار معتبر وارد نمایید.
                            </div>
                        </div>
                        <div class="form-group">
